...
def run_combination(params):
    ...
    SafeW = SafeWhittleAvg([ns, np], na, R.vals, M.transitions, nt, ut, uo, th * numpy.ones(na))
    ...
    processes = [
        ...
        ("Whittl", lambda *args: ProcessAvg_WhtlRB(WhtlW, WhtlW.w_indices, *args)),
        ("Safaty", lambda *args: ProcessAvg_SafeRB(SafeW, SafeW.w_indices, *args))
    ]
...
def main():
    ...
    PATH1 = f'./output-avg/Res_{param_sets["t_type_set"]}{param_sets["n_states_set"]}{param_sets["armcoef_set"]}.xlsx'
    PATH2 = f'./output-avg/ResAvg_{param_sets["t_type_set"]}{param_sets["n_states_set"]}{param_sets["armcoef_set"]}.xlsx'
    PATH3 = f'./output-avg/'
