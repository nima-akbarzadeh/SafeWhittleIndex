...
def Process_SingleSafeRB(SafeW, n_episodes, n_steps, n_states, n_bandits, n_choices, thresholds, rewards, transitions, whittle_indices, initial_states, u_type, u_order):
...
def Process_SingleSoftSafeRB(SafeW, n_episodes, n_steps, n_states, n_bandits, n_choices, thresholds, rewards, transitions, whittle_indices, initial_states, u_type, u_order):
